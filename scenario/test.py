...
def test(args):
    ...
    save_name = os.path.join(checkpoints_path, args.model + '_' + str(args.iteration) + '.pth')
    ...
    model.eval()
    lfw_test(model, img_paths, identity_list, args.test_list_path, args.test_batch_size)
