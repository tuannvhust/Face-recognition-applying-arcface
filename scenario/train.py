    ...
    for i in range(args.num_epoch):
        ...
        for batch_index,batch in enumerate(train_loader):
            ...
            if iters % args.print_freq == 0:
                ...
                print(f'{now_time},train epoch : {i}, iteration : {batch_index}, speed : {speed} iters/s, loss: {loss}, accuracy: {float(accuracy)}')
        ...
        test_metric = {'test_accuracy':float(acc)}
        writer.add_scalars('test_accuracy',test_metric)
